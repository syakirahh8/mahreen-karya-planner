  ...
  return (
    <section className="relative overflow-hidden bg-white pt-12 pb-20 sm:pt-16 sm:pb-28 border-b-2 border-brand-dark/10">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center relative z-10 space-y-8">
        ...
        {/* Main Headline */}
        <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-black tracking-tight text-brand-dark max-w-4xl mx-auto leading-[1.2] sm:leading-[1.15]">
          Ide{' '}
          <span className="relative inline-block px-2.5 sm:px-4 py-0.5 sm:py-1 bg-brand-lavender text-brand-dark rounded-xl sm:rounded-2xl border-2 border-brand-dark -rotate-2 shadow-brutal-sm mx-1">
            Kecil
          </span>{' '}
          Bisa Menjadi{' '}
          <span className="relative inline-block px-2.5 sm:px-4 py-0.5 sm:py-1 bg-brand-yellow text-brand-dark rounded-xl sm:rounded-2xl border-2 border-brand-dark rotate-2 shadow-brutal-sm mx-1">
            Karya
          </span>{' '}
          yang Sangat Berarti.
        </h1>
        ...
        {/* Subtitle */}
        <p className="max-w-2xl mx-auto text-xs sm:text-base text-brand-muted font-sans font-medium leading-relaxed px-2">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 pt-1 sm:pt-2">
          {categories.map((cat) => {
            ...
            return (
              <div
                key={cat.label}
                className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-brand-cream border-2 border-brand-dark text-brand-dark font-sans font-bold text-xs sm:text-sm shadow-brutal-sm hover:-translate-y-0.5 transition-all cursor-default"
              >
        ...
        <div className="pt-2 sm:pt-4 flex justify-center">
          <a
            href="#planner"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 sm:px-10 py-3.5 sm:py-4 rounded-full bg-brand-lavender text-brand-dark font-heading font-black text-sm sm:text-lg border-2 border-brand-dark shadow-brutal hover:shadow-brutal-lg hover:-translate-y-1 active:translate-y-0 transition-all text-center"
          >
