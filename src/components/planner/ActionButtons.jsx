    ...
    <div className="w-full max-w-2xl mx-auto space-y-3 pt-2">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <button
          ...
          onClick={onDownload}
          className="w-full py-4 px-6 rounded-2xl bg-brand-yellow hover:brightness-105 active:scale-[0.98] text-brand-dark font-heading font-black text-sm sm:text-base border-2 border-brand-dark shadow-brutal flex items-center justify-center gap-2.5 transition-all disabled:opacity-50"
        >
          {isDownloading ? (
        ...
        <button
          type="button"
          onClick={onShare}
          className="w-full py-4 px-6 rounded-2xl bg-brand-lavender hover:brightness-105 active:scale-[0.98] text-brand-dark font-heading font-black text-sm sm:text-base border-2 border-brand-dark shadow-brutal flex items-center justify-center gap-2.5 transition-all"
        >
