    ...
    <div className="w-full">
      <div className="border-2 border-brand-dark rounded-3xl bg-brand-cream p-6 sm:p-7 shadow-brutal-lg space-y-6 relative overflow-hidden transition-all">
        ...
        <div className="flex items-center justify-between border-b-2 border-brand-dark/15 pb-4">
          ...
          <span
            className={`px-3 py-0.5 rounded-full font-heading font-extrabold text-[11px] border border-brand-dark ${
              isComplete
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs font-sans">
          ...
          <div className="p-3.5 rounded-2xl bg-white border-2 border-brand-dark shadow-brutal-sm space-y-1">
            ...
            <p
              className={`text-sm font-heading font-bold ${
                interest ? 'text-brand-dark' : 'text-slate-400 italic'
              }`}
            >
          ...
          <div className="p-3.5 rounded-2xl bg-white border-2 border-brand-dark shadow-brutal-sm space-y-1">
            ...
            <p
              className={`text-sm font-heading font-bold ${
                impact ? 'text-brand-dark' : 'text-slate-400 italic'
              }`}
            >
        ...
        {/* Dynamic Detail Cards: My Idea & My First Step */}
        <div className="space-y-3.5">
          ...
          <div className="p-4 rounded-2xl bg-white border-2 border-brand-dark shadow-brutal-sm space-y-1.5">
            ...
            <p
              className={`text-xs sm:text-sm font-sans font-medium leading-relaxed whitespace-pre-wrap ${
                idea?.trim() ? 'text-brand-dark' : 'text-slate-400 italic'
              }`}
            >
          ...
          <div className="p-4 rounded-2xl bg-white border-2 border-brand-dark shadow-brutal-sm space-y-1.5">
            ...
            <p
              className={`text-xs sm:text-sm font-sans font-medium leading-relaxed whitespace-pre-wrap ${
                firstAction?.trim() ? 'text-brand-dark' : 'text-slate-400 italic'
              }`}
            >
