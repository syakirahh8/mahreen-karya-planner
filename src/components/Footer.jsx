  ...
  return (
    <footer className="bg-brand-cream border-t-2 border-brand-dark/10 py-10">
      <motion.div
        ...
        {/* Center / Rights */}
        <div className="text-xs sm:text-sm font-sans font-semibold text-brand-muted text-center sm:text-right space-y-0.5">
          <p>2026 • Mahreen Indonesia — Berkarya untuk Indonesia</p>
          <p className="text-[11px] sm:text-xs opacity-75">Karya Planner Interactive Website Concept</p>
        </div>
      </motion.div>
    </footer>
  )
